...
class gameMenu_Ui_Dialog(QtWidgets.QMainWindow):
    ...
    def gameMenu_setupUi(self, dialog, username):
        ...
        self.gameMenuDialog.resize(808, 880)
        self.gameMenuDialog.setStyleSheet("background-color: rgb(85, 85, 127);")
        self.label = QtWidgets.QLabel(self.gameMenuDialog)
        self.label.setGeometry(QtCore.QRect(90, 270, 251, 251))
        self.label.setStyleSheet("background-image: url(:/newPrefix/User.png);")
        self.label.setText("")
        self.label.setObjectName("label")
        self.frame = QtWidgets.QFrame(self.gameMenuDialog)
        ...
        self.retranslateUi(self.gameMenuDialog)
        QtCore.QMetaObject.connectSlotsByName(self.gameMenuDialog)
        return self.gameMenuDialog
