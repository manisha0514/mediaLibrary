...
class addMovies_Ui_Dialog(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()

    def addMovies_setupUi(self, dialog):
        self.moviedialog = dialog
        self.moviedialog.setObjectName("Dialog")
        self.moviedialog.resize(808, 880)
        self.moviedialog.setStyleSheet("background-color: rgb(85, 85, 127);")

        self.label = QtWidgets.QLabel(self.moviedialog)
        self.label.setGeometry(QtCore.QRect(90, 270, 251, 251))
        self.label.setStyleSheet("background-image: url(:/newPrefix/User.png);")
        self.label.setText("")
        self.label.setObjectName("label")

        self.frame = QtWidgets.QFrame(self.moviedialog)
        ...
        self.movieName = QtWidgets.QLabel(self.frame)
        self.movieName.setGeometry(QtCore.QRect(40, 190, 331, 50))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.movieNameField = QtWidgets.QLineEdit(self.frame)
        self.movieNameField.setGeometry(QtCore.QRect(260, 200, 331, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.movieNameField.setFont(font)
        self.movieNameField.setStyleSheet("color: rgb(244, 35, 20);")
        self.movieNameField.setObjectName("movieNameField")

        self.ActorName = QtWidgets.QLabel(self.frame)
        self.ActorName.setGeometry(QtCore.QRect(40, 250, 331, 50))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(16)
        self.ActorName.setFont(font)
        self.ActorName.setStyleSheet("color: rgb(0, 0, 0);")
        self.ActorName.setObjectName("ActorName")
        ...
        self.movieYear = QtWidgets.QLabel(self.frame)
        self.movieYear.setGeometry(QtCore.QRect(40, 310, 331, 50))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(16)
        self.movieYear.setFont(font)
        self.movieYear.setStyleSheet("color: rgb(0, 0, 0);")
        ...
        self.directorName = QtWidgets.QLabel(self.frame)
        self.directorName.setGeometry(QtCore.QRect(40, 370, 331, 50))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(16)
        self.directorName.setFont(font)
        self.directorName.setStyleSheet("color: rgb(0, 0, 0);")
        self.directorName.setObjectName("directorName")

        self.directorField = QtWidgets.QLineEdit(self.frame)
        self.directorField.setGeometry(QtCore.QRect(260, 380, 331, 40))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.directorField.setFont(font)
        self.directorField.setStyleSheet("color: rgb(244, 35, 20);")
        self.directorField.setObjectName("directorField")
        ...
        self.retranslateUi(self.moviedialog)
        QtCore.QMetaObject.connectSlotsByName(self.moviedialog)
        return self.moviedialog
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_1.setText(_translate("Dialog", "Add Movie File"))
        self.movieName.setText(_translate("Dialog", "Movie Name"))
        self.ActorName.setText(_translate("Dialog", "Actor Name"))
        self.movieYear.setText(_translate("Dialog", "Movie Year"))
        self.directorName.setText(_translate("Dialog", "Director Name"))
